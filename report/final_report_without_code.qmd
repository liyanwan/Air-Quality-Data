...
# 2. Strategic Questions and Decison Impact

## Q1 - Traffic Management and Measurable AQI Reduction

Does daily traffic volume materially and consistently drive next-day AQI after adjusting for weather?

### **Executive Implication**

If the relationship is stable and economically meaningful, traffic becomes an actionable policy lever. This supports:

-   Forecast-triggered congestion controls

-   Seasonal tightening (e.g., winter mitigation focus)

-   Quantifiable evaluation of transportation policy impact

Q1 determines whether traffic management can reliably improve short-term air quality — and whether it can be operationalized.

## Q2 - When Does Risk Concentrate?

At what hours, days, and seasons does pollution risk structurally peak — and is this consistent across locations?

### **Executive Implications**

If exposure windows are predictable, response should be time-specific rather than uniform. This enables:

-   Targeted advisory timing

-   Peak-hour mitigation deployment

-   Seasonally calibrated intervention

-   Geographic prioritization

Q2 defines when and where intervention delivers the highest marginal impact.

This analysis identifies predictable exposure windows where risk is systematically elevated.

## Forecasting - Can We Operationalize This?

Are these structural effects stable enough to support reliable next-day AQI forecasting?

### **Executive Implication**

If yes, forecasting can shift from analytical insight to operational tool — powering automated advisories and pre-emptive mitigation.

The leadership decision is not whether we can model AQI — but whether model accuracy, stability, and interpretability are sufficient for deployment at scale.

# 3. Executive Summary

## 3.1 Structural and Predictive Evidence

Our model integrates next-day forecasting with hierarchical time-structure analysis. Results show that AQI across Ontario is systematically structured rather than random.
